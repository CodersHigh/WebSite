require = (function e(b, g, d) {
    ...
    2: [function(b, c, a) {
        ...
        "./data": 4,
        "@marcom/ac-polyfills/Array/prototype.filter": 69,
        "@marcom/ac-polyfills/Array/prototype.some": 74
    }
    ],
    3: [function(b, c, a) {
        c.exports = {
    ...
    5: [function(b, c, a) {
        ...
        "./className/add": 7,
        "@marcom/ac-polyfills/Array/prototype.slice": 73,
        "@marcom/ac-polyfills/Element/prototype.classList": 75
    }
    ],
    6: [function(b, c, a) {
        c.exports = {
    ...
    17: [function(f, d, h) {
        ...
        "./shared/getStyleTestElement": 19,
        "./shared/prefixHelper": 20,
        "./shared/stylePropertyCache": 21,
        "./utils/toCSS": 23,
        "./utils/toDOM": 24
    }
    ],
    ...
    22: [function(c, b, d) {
        ...
        "./getStyleTestElement": 19,
        "./stylePropertyCache": 21
    }
    ],
    23: [function(c, d, b) {
    ...
    25: [function(c, d, b) {
        ...
        "@marcom/ac-function/memoize": 15,
        "@marcom/ac-prefixer/getStyleProperty": 17,
        "@marcom/ac-prefixer/getStyleValue": 18
    }
    ],
    26: [function(b, c, a) {
        c.exports = {
    ...
    27: [function(c, d, b) {
        ...
        "./helpers/globals": 26,
        "@marcom/ac-function/once": 16,
        "@marcom/ac-polyfills/matchMedia": 81
    }
    ],
    28: [function(c, d, b) {
        var g = c("./helpers/globals");
    ...
    30: [function(b, d, a) {
        ...
        "@marcom/ac-classlist/remove": 13,
        "@marcom/ac-object/extend": 31
    }
    ],
    31: [function(c, d, b) {
        ...
        "@marcom/ac-polyfills/Array/prototype.forEach": 70
    }
    ],
    32: [function(c, d, a) {
    ...
    52: [function(g, c, i) {
        ...
        "@marcom/ac-dom-nodes/COMMENT_NODE": 36,
        "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 37,
        "@marcom/ac-dom-nodes/DOCUMENT_NODE": 38,
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 39,
        "@marcom/ac-dom-nodes/TEXT_NODE": 40,
        "@marcom/ac-dom-nodes/isNode": 47,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 71
    }
    ],
    53: [function(d, f, c) {
        ...
        "./internal/nativeMatches": 51,
        "./internal/validate": 52,
        "./shims/matchesSelector": 56,
        "@marcom/ac-dom-nodes/isElement": 46
    }
    ],
    54: [function(c, d, a) {
    ...
    59: [function(b, c, a) {
        ...
        "./ac-event-emitter-micro/EventEmitterMicro": 60
    }
    ],
    60: [function(b, c, a) {
        function f() {
    ...
    63: [function(b, a, f) {
        ...
        "@marcom/ac-event-emitter-micro": 59,
        "@marcom/ac-feature/mediaQueriesAvailable": 27,
        "@marcom/ac-polyfills/Function/prototype.bind": 76,
        "@marcom/ac-polyfills/Object/create": 77,
        "@marcom/ac-polyfills/Object/keys": 78
    }
    ],
    64: [function(m, a, u) {
        m("@marcom/ac-polyfills/Function/prototype.bind");
        var i = m("@marcom/ac-dom-events/utils/addEventListener");
        var l = m("@marcom/ac-dom-events/preventDefault");
        var s = m("@marcom/ac-dom-events/target");
        var g = m("@marcom/ac-dom-traversal/querySelector");
        var t = m("@marcom/ac-dom-traversal/ancestor");
        var b = m("@marcom/ac-classlist");
        var j = m("@marcom/ac-dom-nodes/hasAttribute");
        var q = m("@marcom/ac-dom-nodes/isElement");
        var d = m("@marcom/ac-feature/cssPropertyAvailable");
        var h = m("@marcom/ac-viewport-emitter/ViewportEmitter");
        var o = m("@marcom/ac-object/defaults");
        var f = m("./internal/CheckboxMenu");
        var k = m("./internal/SimpleSticky");
        var n = m("./internal/ClickAway");
        var c = {
            className: "localnav"
        };
        var r = function(x, w) {
            ...
            w = o(c, w || {});
            this.el = x;
            v = w.selector || "." + w.className;
            this._selectors = {
                traySelector: w.traySelector || "." + w.className + "-menu-tray",
                viewportEmitterID: w.viewportEmitterID || w.className + "-viewport-emitter",
                curtainID: w.curtainID || w.className + "-curtain",
                menuStateID: w.menuStateID || w.className + "-menustate",
                menuOpeningClassName: w.menuOpeningClassName || w.className + "-opening"
            };
            this._selectors.clickAwaySelector = v + ", #" + this._selectors.curtainID + ", #" + this._selectors.menuStateID;
            this.tray = g(this._selectors.traySelector, this.el);
            this.stickyEnabled = this._getStickyEnabled();
            this._transitionsAvailable = d("transition");
            this._viewports = new h(this._selectors.viewportEmitterID);
            if (this.stickyEnabled) {
                this._sticky = new k(this.el, w)
            }
            this._initializeMenu()
        };
        r.create = function(w, v) {
            return new r(w, v)
        };
        var p = r.prototype;
        p._getStickyEnabled = function() {
            return j(this.el, "data-sticky")
        };
        p._initializeMenu = function() {
            var y = document.getElementById(this._selectors.menuStateID);
            var v = document.getElementById(this._selectors.menuStateID + "-open");
            var x = document.getElementById(this._selectors.menuStateID + "-close");
            var z = ("onpopstate" in window) ? "popstate": "beforeunload";
            var w;
            if (y && v && x) {
                this.menu = new f(y, v, x);
                this.menu.on("open", this._onMenuOpen.bind(this));
                this._viewports.on("change", this._onViewportChange.bind(this));
                i(window, "scroll", this._onScroll.bind(this));
                i(window, "touchmove", this._onScroll.bind(this));
                i(this.tray, "click", this._onTrayClick.bind(this));
                this._closeMenu = this._closeMenu.bind(this);
                i(window, z, this._closeMenu);
                i(window, "orientationchange", this._closeMenu);
                w = new n(this._selectors.clickAwaySelector);
                w.on("click", this._closeMenu);
                if (this._transitionsAvailable) {
                    i(this.tray, "transitionend", this._enableMenuScroll.bind(this))
                }
            }
        };
        ...
        p._onScroll = function(v) {
            ...
            if (this.menu.isOpen()) {
                ...
                if (this._menuCollapseOnScroll) {
                    ...
                    w = s(v);
                    if (!q(w) ||!t(w, this._selectors.traySelector, true)) {
                        l(v)
                    }
                }
            }
        };
        p._onTrayClick = function(v) {
            var w = s(v);
            if ("href" in w) {
                this._closeMenu()
            }
        };
        p._onViewportChange = function(v) {
            if (v.to === "medium" || v.to === "large") {
                this._closeMenu()
            }
        };
        p._disableMenuScrollbar = function() {
            b.add(this.el, this._selectors.menuOpeningClassName)
        };
        p._enableMenuScroll = function() {
            b.remove(this.el, this._selectors.menuOpeningClassName)
        };
        ...
        "./internal/CheckboxMenu": 65,
        "./internal/ClickAway": 66,
        "./internal/SimpleSticky": 67,
        "@marcom/ac-classlist": 12,
        "@marcom/ac-dom-events/preventDefault": 32,
        "@marcom/ac-dom-events/target": 33,
        "@marcom/ac-dom-events/utils/addEventListener": 34,
        "@marcom/ac-dom-nodes/hasAttribute": 41,
        "@marcom/ac-dom-nodes/isElement": 46,
        "@marcom/ac-dom-traversal/ancestor": 49,
        "@marcom/ac-dom-traversal/querySelector": 54,
        "@marcom/ac-feature/cssPropertyAvailable": 25,
        "@marcom/ac-object/defaults": 61,
        "@marcom/ac-polyfills/Function/prototype.bind": 76,
        "@marcom/ac-viewport-emitter/ViewportEmitter": 63
    }
    ],
    65: [function(b, a, c) {
        b("@marcom/ac-polyfills/Object/create");
        var j = b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var g = b("@marcom/ac-dom-events/utils/addEventListener");
        var h = b("@marcom/ac-dom-events/preventDefault");
        function f(l, k, m) {
            j.call(this);
            this.el = l;
            this.anchorOpen = k;
            ...
            g(this.el, "change", this.update.bind(this));
            g(this.anchorOpen, "click", this._anchorOpenClick.bind(this));
            g(this.anchorClose, "click", this._anchorCloseClick.bind(this));
            if (window.location.hash === "#" + l.id) {
                window.location.hash = ""
            }
        }
        f.create = function(l, k, m) {
            return new f(l, k, m)
        };
        var i = j.prototype;
        var d = f.prototype = Object.create(i);
        f.prototype.constructor = f;
        d.update = function() {
            var k = this.isOpen();
            if (k !== this._lastOpen) {
                this.trigger(k ? "open" : "close");
                this._lastOpen = k
            }
        };
        d.isOpen = function() {
        ...
        d._anchorOpenClick = function(k) {
            h(k);
            this.open();
            this.anchorClose.focus()
        };
        d._anchorCloseClick = function(k) {
            h(k);
            this.close();
    ...
    66: [function(c, b, d) {
        ...
        var j = c("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var g = c("@marcom/ac-dom-events/utils/addEventListener");
        var a = c("@marcom/ac-dom-events/target");
        var k = c("@marcom/ac-dom-traversal/ancestors");
        function h(l) {
            j.call(this);
            this._selector = l;
            this._touching = false;
            g(document, "click", this._onClick.bind(this));
            g(document, "touchstart", this._onTouchStart.bind(this));
            g(document, "touchend", this._onTouchEnd.bind(this))
        }
        var i = j.prototype;
        var f = h.prototype = Object.create(i);
        h.prototype.constructor = h;
        f._checkTarget = function(l) {
            var m = a(l);
            if (!k(m, this._selector, true).length) {
                this.trigger("click", l)
            }
        };
        f._onClick = function(l) {
            if (!this._touching) {
                this._checkTarget(l)
            }
        };
        f._onTouchStart = function(l) {
            this._touching = true;
            this._checkTarget(l)
        };
        f._onTouchEnd = function() {
            this._touching = false
        };
        b.exports = h
    }, {
        "@marcom/ac-dom-events/target": 33,
        "@marcom/ac-dom-events/utils/addEventListener": 34,
        "@marcom/ac-dom-traversal/ancestors": 50,
        "@marcom/ac-event-emitter-micro": 59,
        "@marcom/ac-polyfills/Function/prototype.bind": 76,
        "@marcom/ac-polyfills/Object/create": 77
    }
    ...
    67: [function(c, b, d) {
        c("@marcom/ac-polyfills/Object/create");
        var o = c("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var h = c("@marcom/ac-dom-events/utils/addEventListener");
        var k = c("@marcom/ac-feature/cssPropertyAvailable");
        var g = c("@marcom/ac-dom-nodes/insertBefore");
        var l = c("@marcom/ac-dom-metrics/getScrollY");
        var i = c("@marcom/ac-classlist/add");
        var n = c("@marcom/ac-classlist/remove");
        var a = "css-sticky";
        var j = function(q, p) {
            o.call(this);
            this.el = q;
            this.stuck = false;
            this._selectors = {
                placeholderID: p.placeholderID || p.className + "-sticky-placeholder",
                stuckClassName: p.stuckClassName || p.className + "-sticking"
            };
            this._createPlaceholder();
            this._featureDetection();
            this._updatePosition = this._updatePosition.bind(this);
            this._updatePlaceholderOffset = this._updatePlaceholderOffset.bind(this);
            h(window, "scroll", this._updatePosition);
            h(document, "touchmove", this._updatePosition);
            h(window, "resize", this._updatePlaceholderOffset);
            h(window, "orientationchange", this._updatePlaceholderOffset);
        ...
        j.create = function(q, p) {
            return new j(q, p)
        };
        var m = o.prototype;
        var f = j.prototype = Object.create(m);
        j.prototype.constructor = j;
        f._featureDetection = function() {
            var q = k("position", "sticky");
            var p = a;
            if (!q) {
                p = "no-" + p
            }
            i(this.el, p);
            i(this.placeholder, p)
        };
        ...
        f._updatePlaceholderOffset = function() {
            var p = this.placeholder.offsetTop;
            p += document.documentElement.offsetTop + document.body.offsetTop;
            if (p !== this._placeholderOffset) {
                this._placeholderOffset = p;
        ...
        f._updatePosition = function() {
            ...
            if (p > this._placeholderOffset) {
                if (!this.stuck) {
                    i(this.el, this._selectors.stuckClassName);
                    i(this.placeholder, this._selectors.stuckClassName);
                    this.stuck = true;
                    this.trigger("stuck")
                }
            } else {
                if (this.stuck) {
                    n(this.el, this._selectors.stuckClassName);
                    n(this.placeholder, this._selectors.stuckClassName);
                    this.stuck = false;
        ...
        "@marcom/ac-classlist/remove": 13,
        "@marcom/ac-dom-events/utils/addEventListener": 34,
        "@marcom/ac-dom-metrics/getScrollY": 35,
        "@marcom/ac-dom-nodes/insertBefore": 42,
        "@marcom/ac-event-emitter-micro": 59,
        "@marcom/ac-feature/cssPropertyAvailable": 25,
        "@marcom/ac-polyfills/Object/create": 77
    }
    ...
    hfMHj0: [function(c, d, a) {
        ...
        c("@marcom/ac-polyfills/Array/prototype.filter");
        c("@marcom/ac-polyfills/Array/prototype.forEach");
        c("@marcom/ac-polyfills/Array/prototype.indexOf");
        c("@marcom/ac-polyfills/Array/prototype.map");
        c("@marcom/ac-polyfills/Array/prototype.some");
        c("@marcom/ac-polyfills/getComputedStyle");
        c("@marcom/ac-polyfills/String/prototype.trim");
        ...
        "@marcom/ac-polyfills/Array/isArray": 68,
        "@marcom/ac-polyfills/Array/prototype.filter": 69,
        "@marcom/ac-polyfills/Array/prototype.forEach": 70,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 71,
        "@marcom/ac-polyfills/Array/prototype.map": 72,
        "@marcom/ac-polyfills/Array/prototype.some": 74,
        "@marcom/ac-polyfills/String/prototype.trim": 79,
        "@marcom/ac-polyfills/getComputedStyle": 80
    }
    ],
    ...
    fkFiXJ: [function(b, a, f) {
        ...
        "@marcom/ac-classlist": 12,
        "@marcom/ac-headjs/FeatureDetect": 30,
        "@marcom/ac-localnav/Localnav": 64,
        "@marcom/ac-polyfills/Function/prototype.bind": 76
    }
    ],
    ...
    o3ncwG: [function(d, f, c) {
        var g = d("@marcom/ac-browser");
        var a = d("@marcom/ac-feature/touchAvailable");
        var b = d("@marcom/ac-feature/svgAvailable");
        f.exports = {
            touch: a,
            svg: b,
            ie7: (g.IE && g.IE.documentMode === 7),
            ie8: (g.IE && g.IE.documentMode === 8)
        }
    }, {
        "@marcom/ac-browser": 1,
        "@marcom/ac-feature/svgAvailable": 28,
        "@marcom/ac-feature/touchAvailable": 29
    }
    ],
